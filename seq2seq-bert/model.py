    ...
    with tf.Session() as sess:
        with tf.device("/cpu:0"):
            ...
            while True:
                ...
                print('dream:', ''.join([rev_dictionary_input[n] for n in inputs_ids if n not in [0]]))
                print('dream decoding:', ''.join([rev_dictionary_output[n] for n in predicted2[0] if n not in [0]]))
                print("*" * 20)
